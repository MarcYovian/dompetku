...
<div class="p-4 sm:p-6 text-gray-900 dark:text-gray-100">
    ...
    {{-- Header --}}
    <h2 class="text-2xl font-semibold mb-6">{{ __('Transfer From Fund Source') }}</h2>
    ...
    <form wire:submit.prevent="save" class="p-6 bg-white dark:bg-gray-800 rounded-xl shadow-md">
        {{-- Grid Container --}}
